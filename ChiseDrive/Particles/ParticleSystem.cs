...
namespace ChiseDrive.Particles
{
    ...
    public class ParticleSystem
    {
        ...
        static Dictionary<String, ParticleSystem> library = new Dictionary<string, ParticleSystem>();
        static public ChiseDriveGame Game;
        static public ParticleSystem TryGetCreateSystem(string name)
        {
            ParticleSystem system;

            library.TryGetValue(name, out system);

            if (system == null)
            {
                if (Game != null)
                {
                    system = new ParticleSystem(Game, name);
                    if (system != null)
                    {
                        library.Add(name, system);
                    }
                }
            }
        ...
        {
            foreach (KeyValuePair<string, ParticleSystem> kvp in library)
            {
                kvp.Value.Update(elapsed);
            }
        }
        ...
        /// Constructor.
        /// </summary>
        public ParticleSystem(Game game, string settingsName)
        {
            this.content = game.Content;
            this.settingsName = settingsName;

            LoadContent(game.GraphicsDevice);
        }
        ...
        /// </summary>
        protected void LoadContent(GraphicsDevice device)
        {
        ...
        void InitializeParticleEffect()
        {
            ...
            particleEffect.CurrentTechnique =
                                    particleEffect.Techniques[settings.TechniqueName];
        }
