...
namespace ChiseDrive.Graphics.InstancedModel
{
    ...
    internal class InstancedModelPart
    {
        ...
        public void Draw(InstancingTechnique instancingTechnique,
                         Matrix[] instanceTransforms, Matrix view, Matrix projection)
        {
            if (instancingTechnique == InstancingTechnique.NoInstancingOrStateBatching)
            {
                ...
                DrawNoInstancingOrStateBatching(instanceTransforms, view, projection);
            }
            else
            {
                SetRenderStates(instancingTechnique, view, projection);
        ...
        /// </summary>
        void DrawShaderInstancing(Matrix[] instanceTransforms)
        {
        ...
        /// </summary>
        void DrawNoInstancing(Matrix[] instanceTransforms)
        {
            EffectParameter transform = effect.Parameters["NoInstancingTransform"];
                                             ...
                                             Matrix view, Matrix projection)
        {
            ...
            for (int i = 0; i < instanceTransforms.Length; i++)
            {
                ...
                SetRenderStates(InstancingTechnique.NoInstancing, view, projection);
